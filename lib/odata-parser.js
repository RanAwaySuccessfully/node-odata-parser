...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c120 = function(a, i) {return i;},
      peg$c121 = function(a, list) {
                                          if (list === "") list = [];
      ...
      peg$c122 = "$callback=",
      peg$c123 = peg$literalExpectation("$callback=", false),
      peg$c124 = function(a) { return { '$callback': a }; },
      peg$c125 = "$top=",
      peg$c126 = peg$literalExpectation("$top=", false),
      peg$c127 = function(a) { return { '$top': ~~a }; },
      peg$c128 = peg$anyExpectation(),
      peg$c129 = function() { return {"error": 'invalid $top parameter'}; },
      peg$c130 = "$expand=",
      peg$c131 = peg$literalExpectation("$expand=", false),
      peg$c132 = function(list) { return { "$expand": list }; },
      peg$c133 = function() { return {"error": 'invalid $expand parameter'}; },
      peg$c134 = ",",
      peg$c135 = peg$literalExpectation(",", false),
      peg$c136 = function(i, l) {return l;},
      peg$c137 = function(i, list) {
                                          if (list === "") list = [];
                                          if (require('util').isArray(list[0])) {
                                              list = list[0];
                                          }
      ...
      peg$c138 = "$skip=",
      peg$c139 = peg$literalExpectation("$skip=", false),
      peg$c140 = function(a) {return {'$skip': ~~a }; },
      peg$c141 = function() { return {"error": 'invalid $skip parameter'}; },
      peg$c142 = "$format=",
      peg$c143 = peg$literalExpectation("$format=", false),
      peg$c144 = function(v) { return {'$format': v.join('') }; },
      peg$c145 = function() { return {"error": 'invalid $format parameter'}; },
      peg$c146 = "$inlinecount=",
      peg$c147 = peg$literalExpectation("$inlinecount=", false),
      peg$c148 = "allpages",
      peg$c149 = peg$literalExpectation("allpages", false),
      peg$c150 = "none",
      peg$c151 = peg$literalExpectation("none", false),
      peg$c152 = function(v) { return {'$inlinecount': v }; },
      peg$c153 = function() { return {"error": 'invalid $inlinecount parameter'}; },
      peg$c154 = "$orderby=",
      peg$c155 = peg$literalExpectation("$orderby=", false),
      peg$c156 = function(list) {
                                          return { "$orderby": list }; },
      peg$c157 = function() { return {"error": 'invalid $orderby parameter'}; },
      peg$c158 = "asc",
      peg$c159 = peg$literalExpectation("asc", false),
      peg$c160 = "desc",
      peg$c161 = peg$literalExpectation("desc", false),
      peg$c162 = function(id, ord) {
                                          var result = {};
                                          result[id] = ord[1] || 'asc';
                                          return result;
                                      },
      peg$c163 = function(i, list) {
      ...
      peg$c164 = "$select=",
      peg$c165 = peg$literalExpectation("$select=", false),
      peg$c166 = function(list) { return { "$select":list }; },
      peg$c167 = function() { return {"error": 'invalid $select parameter'}; },
      peg$c168 = "/",
      peg$c169 = peg$literalExpectation("/", false),
      peg$c170 = function(i, list) {
                                          if (require('util').isArray(list[0])) {
                                              list = list[0];
                                          }
                                          return "/" + i + list;
      ...
      peg$c173 = function(a, b) {return a + b;},
      peg$c174 = "*",
      peg$c175 = peg$literalExpectation("*", false),
      peg$c176 = "$filter=",
      peg$c177 = peg$literalExpectation("$filter=", false),
      peg$c178 = function(list) {
                                          return {
                                              "$filter": list
                                          };
                                      },
      peg$c179 = function() { return {"error": 'invalid $filter parameter'}; },
      peg$c180 = "(",
      peg$c181 = peg$literalExpectation("(", false),
      peg$c182 = ")",
      peg$c183 = peg$literalExpectation(")", false),
      peg$c184 = function(filter) {return filter},
      peg$c185 = "and",
      peg$c186 = peg$literalExpectation("and", false),
      peg$c187 = "or",
      peg$c188 = peg$literalExpectation("or", false),
      peg$c189 = function(left, type, value) {
                                          return { type: type, value: value}
                                    },
      peg$c190 = function(left, right) {
                                      return filterExprHelper(left, right);
                                    },
      peg$c191 = "substringof",
      peg$c192 = peg$literalExpectation("substringof", false),
      peg$c193 = "endswith",
      peg$c194 = peg$literalExpectation("endswith", false),
      peg$c195 = "startswith",
      peg$c196 = peg$literalExpectation("startswith", false),
      peg$c197 = "IsOf",
      peg$c198 = peg$literalExpectation("IsOf", false),
      peg$c199 = function(f, arg0, arg1) {
                                          return {
                                              type: "functioncall",
                                              func: f,
                                              args: [arg0, arg1]
      ...
      peg$c200 = "IsOf(",
      peg$c201 = peg$literalExpectation("IsOf(", false),
      peg$c202 = function(arg0) {
                                          return {
                                              type: "functioncall",
                                              func: "IsOf",
                                              args: [arg0]
      ...
      peg$c203 = "tolower",
      peg$c204 = peg$literalExpectation("tolower", false),
      peg$c205 = "toupper",
      peg$c206 = peg$literalExpectation("toupper", false),
      peg$c207 = "trim",
      peg$c208 = peg$literalExpectation("trim", false),
      peg$c209 = "length",
      peg$c210 = peg$literalExpectation("length", false),
      peg$c211 = "year",
      peg$c212 = peg$literalExpectation("year", false),
      peg$c213 = "month",
      peg$c214 = peg$literalExpectation("month", false),
      peg$c215 = "day",
      peg$c216 = peg$literalExpectation("day", false),
      peg$c217 = "hour",
      peg$c218 = peg$literalExpectation("hour", false),
      peg$c219 = "minute",
      peg$c220 = peg$literalExpectation("minute", false),
      peg$c221 = "second",
      peg$c222 = peg$literalExpectation("second", false),
      peg$c223 = "round",
      peg$c224 = peg$literalExpectation("round", false),
      peg$c225 = "floor",
      peg$c226 = peg$literalExpectation("floor", false),
      peg$c227 = "ceiling",
      peg$c228 = peg$literalExpectation("ceiling", false),
      peg$c229 = function(f, arg0) {
                                        return {
                                            type: "functioncall",
                                            func: f,
                                            args: [arg0]
      ...
      peg$c230 = "indexof",
      peg$c231 = peg$literalExpectation("indexof", false),
      peg$c232 = "concat",
      peg$c233 = peg$literalExpectation("concat", false),
      peg$c234 = "substring",
      peg$c235 = peg$literalExpectation("substring", false),
      peg$c236 = "replace",
      peg$c237 = peg$literalExpectation("replace", false),
      peg$c238 = function(f, arg0, arg1) {
                                        return {
                                            type: "functioncall",
                                            func: f,
                                            args: [arg0, arg1]
      ...
      peg$c239 = function(arg0, arg1, arg2) {
                                        return {
                                            type: "functioncall",
                                            func: "substring",
                                            args: [arg0, arg1, arg2]
      ...
      peg$c240 = function(arg0, arg1, arg2) {
                                        return {
                                            type: "functioncall",
                                            func: "replace",
                                            args: [arg0, arg1, arg2]
      ...
      peg$c246 = "ne",
      peg$c247 = peg$literalExpectation("ne", false),
      peg$c248 = "lt",
      peg$c249 = peg$literalExpectation("lt", false),
      peg$c250 = "le",
      peg$c251 = peg$literalExpectation("le", false),
      peg$c252 = "gt",
      peg$c253 = peg$literalExpectation("gt", false),
      peg$c254 = "ge",
      peg$c255 = peg$literalExpectation("ge", false),
      peg$c256 = "add",
      peg$c257 = peg$literalExpectation("add", false),
      peg$c258 = "sub",
      peg$c259 = peg$literalExpectation("sub", false),
      peg$c260 = "mul",
      peg$c261 = peg$literalExpectation("mul", false),
      peg$c262 = "div",
      peg$c263 = peg$literalExpectation("div", false),
      peg$c264 = "mod",
      peg$c265 = peg$literalExpectation("mod", false),
      peg$c266 = "$",
      peg$c267 = peg$literalExpectation("$", false),
      peg$c268 = function(er) { return { error: "unsupported method: " + er }; },
      peg$c269 = "&",
      peg$c270 = peg$literalExpectation("&", false),
      peg$c271 = function(e, el) { return [e].concat(el); },
      peg$c272 = function(e) { return [e]; },
      peg$c273 = function(list) {
  ...
  function peg$parsedateTimeOffset() {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$currPos;
      s1 = peg$parsedateTimeOffsetBody();
      if (s1 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c29(s1);
      }
