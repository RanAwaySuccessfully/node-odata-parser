  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_dateTimeOffset() {
        ...
        if (result0 === null) {
          pos0 = pos;
          result0 = parse_dateTimeOffsetBody();
          if (result0 !== null) {
            result0 = (function(offset, a) { return new Date(a); })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_count() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return {'$count': true}; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          pos0 = pos;
          if (input.substr(pos, 11) === "$count=true") {
            result0 = "$count=true";
            pos += 11;
          } else {
            result0 = null;
            if (reportFailures === 0) {
              matchFailed("\"$count=true\"");
            }
          }
          if (result0 !== null) {
            result0 = (function(offset) { return {'$count': true}; })(pos0);
      ...
      function parse_search() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, searchterm) { return {'$search': searchterm.join('') }; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
